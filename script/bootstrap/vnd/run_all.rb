...
# Master bootstrap script to set up VND merchant user with complete trading setup
require_relative '../../../config/environment'

puts "Starting VND bootstrap process..."
puts "=" * 50
...
puts "\n" + "=" * 50
puts "VND bootstrap process completed successfully!"
puts "VND merchant user 'mikevn@example.com' is now ready for trading."
