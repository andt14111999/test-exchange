    ...
    class TickHandler < BaseHandler
      ...
      def find_or_create_tick(payload)
        ...
        ::Tick.create!(
          ...
          tick_key: tick_key,
          amm_pool: amm_pool,
          liquidity_gross: BigDecimal.safe_convert(payload['liquidityGross']),
          liquidity_net: BigDecimal.safe_convert(payload['liquidityNet']),
          fee_growth_outside0: BigDecimal.safe_convert(payload['feeGrowthOutside0']),
          fee_growth_outside1: BigDecimal.safe_convert(payload['feeGrowthOutside1']),
